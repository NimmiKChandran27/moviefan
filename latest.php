...
<body>
    ...
    <nav id="navbar-example2" class="navbar navbar-light bg-light px-3"></nav>
<center><h1><strong> <i>MOVIES NEAR YOU AND SEATS AVAILABLE</i></strong></h1></center>
<p>
    <div class="container">
        <div class="row">
            <div class="col">
...
<center>
</nav><div class="spinner-border text-primary" role="status">
